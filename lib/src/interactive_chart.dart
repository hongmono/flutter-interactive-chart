      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Listener(
          ...
          child: GestureDetector(
            ...
            onLongPressMoveUpdate: (details) => setState(() => _tapPosition = details.localPosition),
            onLongPressCancel: () => setState(() => _tapPosition = null),
            onLongPressEnd: (_) => setState(() => _tapPosition = null),
            // Pan and zoom
